            ...
            <div class="card">
                ...
                <div class="card-header pt-4">
                    <button type="button" class="btn btn-primary float-right" data-toggle="modal"
                        ...
                        <i class="fa fa-plus"></i> &nbsp TAMBAH KAFALAH
                    </button>
                    <h4>Data Kafalah</h4>
                </div>
                <div class="card-body pt-0">
                    <form action="{{ route('kafalah.store') }}" method="post">
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Tambah Kafalah</h5>
                                    ...
                                    <div class="modal-body">
                                        @csrf
                                        @method('POST')
                                        <x-forms.input name="nama" label="Nama Kafalah" />
                                ...
                                @foreach ($data as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- modal hapus -->
                                            <form method="POST" action="{{ route('kafalah.destroy', $row->id) }}">
                                    ...
                                    <div class="modal fade" id="update_user_{{ $row->id }}" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <form method="POST" action="{{ route('kafalah.update', $row->id) }}">
                                                <div class="modal-content">
                                                    <div class="modal-header">
