                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file" id="exampleFormControlFile1" name="image_file">
                                </div>
                                <textarea class="form-control" name="pesan" required placeholder="Masukkan pesan yang akan dikirim .." rows="7"></textarea>
                            </div>
