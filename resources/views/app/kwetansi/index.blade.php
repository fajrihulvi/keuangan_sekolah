...
@section('konten')
    <div class="content-body">
        <div class="row page-titles mx-0 mt-2">
            <h3 class="col p-md-0">Kwetansi</h3>
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Kwetansi</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header pt-4">
                    <h3 class="card-tit">Filter Kwetansi</h3>
                </div>
                <div class="card-body">
            ...
            <div class="my-2">
                <div class="container">
                    <div class="row" style="gap: 8px; margin-bottom: 16px;">
                        <a target="_BLANK" href="{{ route('kwetansi.pdf',['siswa' => $_GET['siswa'], 'bulan' => $_GET['bulan'], 'tahun' => $_GET['tahun']]) }}" class="btn btn-outline-secondary"><i class="fa fa-file-pdf-o "></i> &nbsp; CETAK PDF</a>
                        <a target="_BLANK" href="{{ route('kwetansi.print',['siswa' => $_GET['siswa'], 'bulan' => $_GET['bulan'], 'tahun' => $_GET['tahun']]) }}" class="btn btn-outline-secondary"><i class="fa fa-print "></i> &nbsp; CETAK PRINT</a>
                    </div>
                    <div class="kw-nav">
