        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-header pt-4">
                    <a href="{{ route('siswa.index') }}" class="btn btn-primary float-right"><i class="fa fa-arrow-left"></i> &nbsp
                        KEMBALI</a>
                    <h4>Tambah Siswa Sistem</h4>
                                ...
                                <div class="form-group">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input id="nama_lengkap" type="text" placeholder="Masukkan nama siswa"
                                            ...
                                            name="nama_lengkap" value="{{ old('nama_lengkap') }}" autocomplete="off">
                                        @error('nama_lengkap')
                                ...
                                <div class="form-group">
                                    <div class="form-group has-feedback">
                                        ...
                                        <textarea name="alamat" id="alamat" cols="30" rows="10"
                                            class="form-control @error('alamat') is-invalid @enderror" placeholder="Masukkan alamat siswa">{{ old('alamat') }}</textarea>
                                        @error('alamat')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
