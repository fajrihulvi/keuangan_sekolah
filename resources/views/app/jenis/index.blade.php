  ...
  <div class="container-fluid">
    ...
    <div class="card">
      ...
      <div class="card-header pt-4">
        <a href="{{ route('jenis.create') }}" class="btn btn-primary float-right"><i class="fa fa-plus"></i> &nbsp TAMBAH JENIS</a>
        <h4>Data Jenis Sistem</h4>
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="text-center">
                    <a href="{{ route('jenis.edit', $row->id) }}" class="btn btn-default btn-sm">
                      <i class="fa fa-cog"></i>
                    </a>
