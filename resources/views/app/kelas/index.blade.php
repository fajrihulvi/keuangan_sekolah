  ...
  <div class="container-fluid">
    ...
    <div class="card">
      ...
      <div class="card-header pt-4">
        <a href="{{ route('kelas.create') }}" class="btn btn-primary float-right"><i class="fa fa-plus"></i> &nbsp TAMBAH KELAS</a>
        <h4>Data Kelas Sistem</h4>
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="text-center">
                    <a href="{{ route('kelas.edit', $row->id) }}" class="btn btn-default btn-sm">
                      <i class="fa fa-cog"></i>
                    </a>
