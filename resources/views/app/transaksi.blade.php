                    ...
                    <form action="{{ route('transaksi') }}" method="GET" class="mb-4">
                        <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control" name="kategori">
                                        ...
                                        @foreach ($kategori as $row)
                                            <option value="{{ $row->id }}" {{ request('kategori') == $row->id ? 'selected' : '' }}>
                                               {{$row->kategori}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="">
                                ...
                                <a href="{{ route('transaksi') }}" class="btn btn-secondary"><i class="fa fa-refresh"></i> Reset</a>
                            </div>
                        </div>
                    </form>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group"
                                                                        ...
                                                                        <select class="form-control py-0"
                                                                            ...
                                                                            <option value="">Pilih</option>
                                                                            <option
                                                                                {{ $t->jenis == 1 ? "selected='selected'" : '' }}
                                                                                value="Pemasukan">Pemasukan</option>
                                                                            <option
                                                                                {{ $t->jenis == 2 ? "selected='selected'" : '' }}
