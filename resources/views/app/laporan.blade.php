                            ...
                            <div class="col-lg-offset-2 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control datepicker2" placeholder="Dari Tanggal" type="text"
                                        required="required" name="dari" value="<?php if (isset($_GET['dari'])) {
                                            echo $_GET['dari'];
                                        } ?>">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control datepicker2" placeholder="Sampai Tanggal" type="text"
                                        required="required" name="sampai" value="<?php if (isset($_GET['sampai'])) {
                                            echo $_GET['sampai'];
                                        } ?>">
                                </div>
                            </div>
            ...
            @if (isset($_GET['kategori']))
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a target="_BLANK"
                            href="{{ route('laporan_excel', ['kategori' => $_GET['kategori'], 'dari' => $_GET['dari'], 'sampai' => $_GET['sampai']]) }}"
                            class="btn btn-outline-secondary"><i class="icon-notebook menu-icon "></i> &nbsp; EKSPORT
                            EXCEL</a>
                        <br>
                        <br>
                        <br>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center" width="7%">TANGGAL</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($transaksi as $t)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $t->kategori->kategori }} <span class="font-italic"> (
                                                {{ $t->kategori->jenis->tipe }} )</span> </td>
                                                <td class="text-center">{{ $t->siswa->nama_lengkap ?? '-' }}</td>
